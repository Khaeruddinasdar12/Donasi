...
<body>
    ...
    <section>
        <div class="input judul">
            <div class="container">
                <h1 class="text-center" style="margin-top:0px;">Nama penerima beasiswa</h1>
                <p class="text-center">Dari Mitra bla bla bla</p>
                <div style="padding-top:20px;">
                    <div class="container">
                        ...
                        <div class="col-md-4">
                            ...
                            <sub style="color:#6b6b6b;">Terakhir kali di donasi pada tanggal 1 januari 2019</sub><br>
                            <sub style="color:#6b6b6b;">Jenjang pendidikan</sub><hr style="background-color:#bebebe; height:1px; border-radius:5px;">
