...
<head>
    ...
    <link rel="stylesheet" href="../css/row.datatabe.min.css" />
    <link rel="stylesheet" href="../css/responsive.datatable.min.css" />
...
<body>
            ...
            <div class="container">
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        ...
                        <a href="daftar-mitra.php" class="list-group-item active">Lihat daftar mitra Posko Yatim</a>
    ...
    <script src="../js/datatable.rowrecorder.min.js"></script>
    <script src="../js/table.responsive.min.js"></script>
