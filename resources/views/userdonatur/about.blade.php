...
<head>
    ...
    <title>Posko Yatim - tentang</title>
    ...
    <section class="style">
        <div class="about" style="padding-top:70px;">
            <div class="jumbotron text-center">
                <h1>Apa itu Posko Yatim?</h1>
                <p class="container">Posko Yatim adalah Lembaga Sosial dan keummatan yang berkhidmat dan berfokus pada upaya membantu,
        ...
        <div class="main-head">
            <div class="col-md-10 col-md-offset-1 info-panel">
                <h4 class="main-header">Visi dan Misi Posko Yatim</h4>
            </div>
        ...
        <div class="main-head">
            <div class="col-md-10 col-md-offset-1 info-panel-2">
                <h4 class="main-header">Struktur Posko Yatim</h4>
            </div>
            <div class="pengurus">
